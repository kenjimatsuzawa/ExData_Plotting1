...
plot(powerpart$datetime, powerpart$Sub_metering_1, type="n", xlab="allow me to use Japanese char for week of the day to avoid to change locale", ylab="Energy sub metering")
...
legend("topright", legend=c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"), col=c("black","red","blue"), lty=c(1,1,1,1))
